(function () {
    ...
    function adjustCardHeightForContent(card) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    if (flipToFrontButton) {
                        flipToFrontButton.classList.add('visible');
                    }
                }, 800); // Wait for height adjustment to complete
    ...
    // Handle window resize to recalculate card-back height
    let resizeTimeout;
    ...
    // Handle flip-to-back button (on card front)
    ...
    if (flipToBackButton) {
        flipToBackButton.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                }, 800); // Wait for height adjustment
    ...
    const flipToFrontButton = document.querySelector('.flip-to-front');
    if (flipToFrontButton) {
        flipToFrontButton.addEventListener('click', () => {
            const card = document.querySelector('.card');
            const cardBack = card.querySelector('.card-back');
            const flipToBackButton = document.querySelector('.flip-to-back');
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    if (flipToBackButton) {
                        flipToBackButton.classList.add('visible');
                    }
                }, 1200); // Wait for flip animation
            }, 800); // Wait for height reset
        });
    }
