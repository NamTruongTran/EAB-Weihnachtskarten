...
const SUPABASE_URL = 'https://zrvzmzfkxxswpbaxnotx.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpydnptemZreHhzd3BiYXhub3R4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ2Nzk4MTMsImV4cCI6MjA4MDI1NTgxM30.UsM4aT03GFWBoR9QcFyQAOKuVKlYHKm0NRb5PapKVIQ';
...
function initializeApp() {
    ...
    ['senderName', 'cardFrontMessage', 'cardBackMessage', 'envelopeColor', 'envelopeTextColor', 'titleColor', 'globalImageUrl', 'globalLogoUrl', 'signature1', 'signature2'].forEach(id => {
    ...
    try {
        ...
        appState.friends = (friends || []).map(friend => ({
            ...
            emailHTML: friend.email_html || createEmailTemplate(
                ...
                friend.custom_logo_url || appState.globalSettings.globalLogoUrl
            )
        }));
    ...
    try {
        ...
        const { error: settingsError } = await supabaseClient
            ...
            .update({
                ...
                signature1: appState.globalSettings.signature1,
                signature2: appState.globalSettings.signature2,
...
function updateUI() {
    ...
    document.getElementById('signature1').value = appState.globalSettings.signature1 || '';
    document.getElementById('signature2').value = appState.globalSettings.signature2 || '';
...
function renderEmailTemplates() {
    ...
    container.innerHTML = appState.friends.map((friend, index) => {
        ...
        const emailHTML = createEmailTemplate(friend.name, url, appState.globalSettings.senderName, envelopeColor, envelopeTextColor, logoUrl);
    ...
    try {
        ...
        if (editIndex === '') {
            ...
            friendData.email_html = createEmailTemplate(
                ...
                friendData.custom_logo_url || appState.globalSettings.globalLogoUrl
            );
